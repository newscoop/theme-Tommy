<footer class="footer-alpha clearfix">
    <div class="footer-main">
        ...
        <div>
            ...
            {{ /list_articles }}
                <li><a target="_blank" href="http://twitter.com/sourcefabric "><span aria-hidden="true" class="icon-twitter"></span> Facebook</a></li>
                <li><a target="_blank"href="http://facebook.com/sourcefabric "><span aria-hidden="true" class="icon-facebook"></span> Twitter</a></li>
